...
#define BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(pos)                                 \
    inline BOOST_ACTOR_OPTIONAL_VARIANT_DATA_CONCAT(T, pos) &                         \
    get(std::integral_constant<int, pos >) {                                   \
        return BOOST_ACTOR_OPTIONAL_VARIANT_DATA_CONCAT(v, pos) ;                     \
    }                                                                          \
    inline const BOOST_ACTOR_OPTIONAL_VARIANT_DATA_CONCAT(T, pos) &                   \
...
struct optional_variant_data {
    ...
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(0)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(1)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(2)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(3)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(4)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(5)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(6)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(7)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(8)
    BOOST_ACTOR_OPTIONAL_VARIANT_DATA_GETTER(9)
