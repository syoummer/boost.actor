 ...
 * BOOST_ACTOR_LOG_ERROR messages. To enable more debugging output, you can define
 * BOOST_ACTOR_LOG_LEVEL to:
 * 1: + warning
 * 2: + info
 * 3: + debug
...
#   define BOOST_ACTOR_LOG_IMPL(lvlname, classname, funname, message)          \
        ...
        ::boost::actor::get_logger()->log(lvlname, classname, funname, __FILE__,       \
...
#   define BOOST_ACTOR_SET_AID(aid_arg)                                        \
    ::boost::actor::get_logger()->set_aid(aid_arg)
#endif

#define BOOST_ACTOR_CLASS_NAME ::boost::actor::detail::demangle(typeid(decltype(*this))).c_str()
...
#       define BOOST_ACTOR_PRINT4(lvlname, classname, funname, msg)                   \
               ::boost::actor::logging::trace_helper cppa_trace_helper_ {              \
                   classname, funname, __FILE__, __LINE__,                     \
                   (::boost::actor::oss_wr{} << msg).str()                             \
               }
#endif
