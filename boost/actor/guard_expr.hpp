...
#ifndef BOOST_ACTOR_GUARD_EXPR_HPP
#define BOOST_ACTOR_GUARD_EXPR_HPP
 ...
 **/
#define BOOST_ACTOR_FORALL_DEFAULT_OPS(SubMacro)                                      \
...
#define BOOST_ACTOR_GE_OPERATOR(EnumValue, Operator)                                  \
...
BOOST_ACTOR_FORALL_DEFAULT_OPS(BOOST_ACTOR_GE_OPERATOR)
BOOST_ACTOR_GE_OPERATOR(equal_op, ==)
BOOST_ACTOR_GE_OPERATOR(not_equal_op, !=)

template<operator_id OP>
struct ge_eval_op;

#define BOOST_ACTOR_EVAL_OP_IMPL(EnumValue, Operator)                                 \
...
BOOST_ACTOR_FORALL_DEFAULT_OPS(BOOST_ACTOR_EVAL_OP_IMPL)

BOOST_ACTOR_EVAL_OP_IMPL(logical_and_op, &&)
BOOST_ACTOR_EVAL_OP_IMPL(logical_or_op, ||)
...
#endif // BOOST_ACTOR_GUARD_EXPR_HPP
