...
#include "boost/actor/detail/optional_variant_data.hpp"

#define BOOST_ACTOR_OPTIONAL_VARIANT_CASE(x)                                          \
 ...
 private:
    ...
    static auto do_apply(Self& from, Visitor& visitor) -> decltype(visitor(none_t{})) {
        switch (from.m_type) {
            ...
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(0);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(1);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(2);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(3);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(4);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(5);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(6);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(7);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(8);
            BOOST_ACTOR_OPTIONAL_VARIANT_CASE(9);
        }
    }
